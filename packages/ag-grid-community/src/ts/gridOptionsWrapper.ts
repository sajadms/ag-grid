...
export class GridOptionsWrapper {
    ...
    public getDomLayout(): string {
        ...
        if (domLayout === Constants.DOM_LAYOUT_PRINT || domLayout === Constants.DOM_LAYOUT_AUTO_HEIGHT || domLayout === Constants.DOM_LAYOUT_NORMAL) {
            return domLayout;
            ...
            _.doOnce(
                () =>
                    console.warn(
                        `ag-Grid: ${this.gridOptions.domLayout} is not valid for DOM Layout, valid values are ${Constants.DOM_LAYOUT_NORMAL}, ${Constants.DOM_LAYOUT_AUTO_HEIGHT} and ${Constants.DOM_LAYOUT_PRINT}`
                    ),
